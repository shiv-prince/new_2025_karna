...
@RoutePage()
class IsNoRiskPage extends StatelessWidget {
  const IsNoRiskPage({super.key});
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Lottie.asset("assets/Heart Protection.json", height: 200),
                const Padding(
                  padding: EdgeInsets.symmetric(horizontal: 20.0),
                  child: Text(
                      textAlign: TextAlign.center,
                      "Your listening for 10hr in 90 DBA is not effecting your health"),
                ),
                SizedBox(
                  height: height * 0.02,
                ),
